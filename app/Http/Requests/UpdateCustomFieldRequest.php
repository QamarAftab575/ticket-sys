...
class UpdateCustomFieldRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'field_type'       => 'sometimes|in:text,number,date,single_select,multi_select,people,dropdown,currency,system_assignee,system_blocked_by,system_blocking,system_completed_on,system_last_modified_on,system_created_on,system_created_by,system_collaborators',
